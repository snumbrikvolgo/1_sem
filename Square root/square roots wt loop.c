// review by Yakov: Сделать проверку ифами с выводом ошибки
//                  Сделать цикл, пока данные не введутся
#include <assert.h>
#include <stdio.h>
#include <math.h>
#define EPS  1e-6 ///< value a number for comparing
#define COMPAREWITHZERO(a) (fabs(a) < EPS)
#define ER_1 -1   ///< input of wrong data
    ...
    switch (SolveSquare(a, b, c, &x1, &x2))
     {
         ...
         case  ER_1: printf("ERROR! WRONG DATA");                                  break;
     }
     return 0;
 }
